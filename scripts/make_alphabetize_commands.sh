  ...
  do
    for feat in ${exp%.wide}*feat
      do
        ...
        echo "python $PCM_DIR/protein_complex_maps/features/alphabetize_pairs.py --feature_pairs $feat --outfile ${feat}.ordered --sep ','  > logs/log_alphabetize_${feat##*/} 2> errors/error_alphabetize_${feat##*/}" 
      done
